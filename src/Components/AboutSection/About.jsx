      ...
      <div class="flex justify-center  mt-14 md:mt-28 px-10 md:px-10">
        <aboutContainer class="relative w-[1120px] h-[720px] rounded-3xl overflow-hidden">
          ...
          <headigContainer class="flex justify-center">
            <headig class="absolute top-[40px] md:top-[64px] text-white font-bold  text-3xl md:text-4xl">
              What are we?
            </headig>
            <div class="absolute w-[56px] h-[2px] top-28 md:top-32 rounded-md bg-white"></div>
          </headigContainer>k,
          <paraContainer class="absolute  top-[140px] md:top-[170px] mx-10 md:mx-24 flex flex-col gap-3 text-center md:text-start md:gap-6">
            <p class="text-white font-normal sm:text-xl text-base md:text-2xl">
